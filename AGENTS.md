...
Go demo app for Deepgram Transcription.
...
```
feat(go-transcription): add diarization support
fix(go-transcription): resolve WebSocket close handling
refactor(go-transcription): simplify session endpoint
